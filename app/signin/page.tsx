      ...
      <section className="relative z-10 container mx-auto px-8 py-24 flex items-center justify-center min-h-[calc(100vh-180px)]">
        <div className="w-full max-w-md">
          <div className="mb-12 text-center">
            ...
            <p className="text-stone-600 text-lg">Sign in to access your account</p>
          ...
          <div className="relative my-8">
            ...
            <div className="relative flex justify-center text-sm">
              <span className="px-4 bg-[#fafaf9] text-stone-500 font-medium uppercase tracking-wider">Or continue with email</span>
            </div>
          </div>
          ...
          <form onSubmit={handleEmailSignIn} className="space-y-6">
            ...
            <div className="flex items-center justify-between text-sm">
              <label className="flex items-center gap-2 cursor-pointer">
                <input type="checkbox" className="w-4 h-4 border-2 border-stone-900 text-purple-600 focus:ring-purple-600" />
